      ...
      rows: [
        ...
        },
        {
          cells: [
            ...
            "Stored anonymously only while “Help improve readings” is on, free text auto-deleted after 90 days; the third-party AI service processes it under its own terms, and we have required that it not use it to train its models (see the Privacy Policy)",
          ],
        },
      ],
    },
      ...
      rows: [
        ...
        },
        {
          cells: [
            ...
            "Stored anonymously only while “Help improve readings” is on, with free text auto-deleted after 90 days; processed by the third-party AI service under its own terms; we have required that it not be used to train its models",
          ],
        },
      ],
    },
