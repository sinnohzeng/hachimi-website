...
export const en: Translations = {
  ...
  privacy: {
    ...
    sections: [
      {
        heading: "Hachimi.ai (哈基米道长)",
        content:
          "Hachimi.ai (“the App”) is operated by the Hachimi.ai team (“we”, “us”; the operating entity is named in the contact section at the end of this policy). This Privacy Policy explains what data the App processes, why, and your rights.\n\nPlease understand how the App works first. You provide two numbers and write the question on your mind; our unified server performs a fixed Mei Hua Yi Shu (Plum Blossom divination) cast, and a third-party AI model then generates the reading in the voice of Hachimi. Unlike many purely on-device divination utilities, generating a reading necessarily sends your question and the cast to our server, which forwards them to a third-party AI service. The nature of that service, and what we require of it, are set out in section 3. This policy discloses that accordingly.",
      },
      {
        heading: "1. Summary",
        content:
