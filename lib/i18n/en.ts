...
export const en: Translations = {
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Yes — it is part of what you agree to before your first reading. Your question, scenario, hexagram, and reading are saved under an anonymous ID, your typed text is deleted after 90 days, and it is used only to make readings better. Never sold, never used for ads, no outside analytics. Questions about health, a crisis, or a high-risk money decision are the exception: they are stopped up front, never cast, and their text is never stored. Withdrawing consent stops the collection, and resetting your anonymous ID in Settings unlinks past records right away. See section 4 of the Privacy Policy.",
      },
      {
  ...
  privacy: {
    ...
    effectiveDate: "Last updated: July 18, 2026",
    sections: [
      {
  ...
  methodology: {
    ...
    eval: {
      ...
      body: "Whether the words hold up, and whether they cross a red line, isn't left to a hunch. Every build first has to clear a hard gate, and the code doesn't get in if it fails. On top of that, a stronger model judges the readings against 50 set test cases on a regular pass, so quality gets real scrutiny, not just a hunch.",
      stats: [
        {
          value: "50",
          label: "set test cases across four scenarios and three languages",
        },
        {
          value: "9",
    ...
    limits: {
      ...
      cards: [
        ...
        },
        {
          ...
          desc: "For serious things like health, legal, or money, please see a professional. Ask about your health, your safety, or a big money call, and the Master casts nothing: you get a few steady words and where to find real help. What the Master offers is company for how you feel.",
        },
        {
  ...
  dataDeletion: {
    ...
    dataTable: {
      ...
      rows: [
        ...
        {
          cells: [
            "A reading you report",
            "The text of the reported reading, the reason you picked, and your optional note, held in a manual review queue; none of your original question, chart, or memories, and no install identifier or IP address",
            "The whole row is deleted after 30 days",
          ],
        },
      ],
    },
    sections: [
      ...
      {
        heading: "How far deletion goes",
        content:
          "The 90 days and 30 days above are the deadlines for deletion from our database. After a row is deleted, our infrastructure provider still keeps a point-in-time recovery window of up to 30 days for disaster recovery, so deletion is only complete at the backup layer once that window has rolled past. This is how cloud databases generally work, and we will not promise more than is true.\n\n“Delete on-device question data” in Settings clears what this installation can reach. It is not a server-side deletion, and it cannot delete device backups your system already made — that is done in your system's own backup settings.",
      },
      {
