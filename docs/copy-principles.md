...
基米道长是一只温柔的猫系道长。心里慌乱的时候，你报两个数字、写下想问的事，他为你起一卦，陪你把一团乱理出个头绪，再给一个此刻就能做的第一步。他交付的是一点踏实的底气，不是预测。仅供娱乐与情绪陪伴。
...
| 副标题 | 基米道长陪你把心里的事理出个头绪，和一个此刻能做的第一步。 | Master Hachimi helps you untangle what's on your mind, and find one small step you can take right now. |
...
- 基准锚点：起卦加载“基米道长竖起耳朵，替你起这一卦”；结果祝福“卦我读给你听了。别慌，先走这一步，喵”。

## 四、称谓规范（全站强制，刻意分层）

| 场景 | 简体 / 繁体 | English |
|---|---|---|
| 品牌全称 / App 名 / 商店 / 法律主体 / 落款署名 | 哈基米道长 / 哈基米道長 | Master Hachimi |
| 正文人设主语（首选） | 基米道长 / 基米道長 | Master Hachimi（口语可 the Master） |
...
5. 隐私措辞求实：写“我们的后端不留存你的问题与解读”，别写“服务器一概不留”（问题会发往 Gemini，绝对措辞会露矛盾）。
