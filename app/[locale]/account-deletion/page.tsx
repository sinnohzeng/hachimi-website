  ...
  return localizedPageMetadata({
    ...
    description:
      locale === "zh"
        ...
        : "Hachimi.ai has no accounts. You use it without signing in, so there's nothing to delete. Your reading history stays on your phone. See what's saved and how to clear it.",
  });
}
